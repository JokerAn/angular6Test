...
var data = {"type":"PER_PERSON","token":"d2633f6b7b7fa410a398e64141be6d3c","callerId":"1001","callerNos":["18615615281"],"calledNo":"23","payload":{"userId":"141","customerId":41}};
data = JSON.stringify(data);
 
var opt = {
    host:'http://port.51lianlian.cn',
    port:'8080',
    method:'POST',
    path:'/api/v1/binding',
    headers:{
