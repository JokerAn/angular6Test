...
app.get('/', function (req, res, next) {
  var msg = [{
      name: '/curriculum/getList',
      doSomething: '我是curriculum.js 我是查询所有课程'
    },
    {
      name: '/curriculum/delete/oneList',
      doSomething: '我是curriculum.js 我是删除一节课程'
    },
    {
      name: '/users/getList',
      doSomething: '我是users.js我的作用是 查询所有学生信息'
    },
    {
      name: '/users/addOneInfo',
      doSomething: '我是users.js我的作用是 添加一条学生信息'
    }
  ];
  res.send(msg);
})
...
var privateKey = fs.readFileSync('/var/www/ssl/2_www.jokeran.com.key', 'utf8'),
  var certificate = fs.readFileSync('/var/www/ssl/1_www.jokeran.com_bundle.crt', 'utf8');
var credentials = {
  key: privateKey,
  cert: certificate
};
